...
unsigned int nStakeMinAge = 60 * 60 * 4 * 1; // 4 hour
...
const string strMessageMagic = "cinder Signed Message:\n";
...
static const int64_t nTargetTimespan = 1 * 30;  // 30 seconds
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cinder", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    string strPubKey = "04b323b1f285f2da4cbd4d018e60b6226c17689861ae671e1c0736d68d16d459f31987407755c0edd708b93d403f38a94039d5c891b246f1f7748d42403fc344f8";
